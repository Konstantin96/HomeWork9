	...
	do
	{
		...
		case 1:
		{
			...
			for (int i = 1; i <= 2; i++)
			{
				...
				res = 0;
				res1 = 0;
				cout << "Боец № " << i << ". Введите кол-во балов в армрестлинге: ";
				cin >> bal;
				res += bal;
				res1 += bal;
				cout << "Боец № " << i << ". Введите  кол-во балов в боксе: ";
				cin >> bal;
				res += bal;
				res1 += bal;
				cout << "Боец № " << i << ". Введите  кол-во балов в дзюдо: ";
				cin >> bal;
				res += bal;
				res1 += bal;
				cout << "Боец № " << i << ". Введите  кол-во балов в самбо: ";
				cin >> bal;
				res += bal;
				res1 += bal;
				cout << "Боец № " << i << ". Введите  кол-во балов в ДЖИ?У-ДЖИ?ТСУ: ";
				cin >> bal;
				res += bal;
				res1 += bal;
			}
		...
		case 3:
		{
			/*В области 12 районов. Известны количество жителей (в тысячах человек)  и площадь (в км2) каждого района. Определить среднюю плотность населения по области в целом.*/
			int nas, s;
			cout << "Введите плотность населения  ";
